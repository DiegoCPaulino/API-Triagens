...
**Projeto API-Triagens** | Disciplina: Computational Thinking Using Python | FIAP — ADS
...
## Endpoints principais (23 no total)

| Grupo | Endpoints |
|---|---|
| Saúde | `GET /api/health` |
| Triagens | `GET /api/triagens/`, `GET /api/triagens/<id>`, `POST /api/triagens/`, `PUT /api/triagens/<id>`, `DELETE /api/triagens/<id>`, `PATCH /api/triagens/<id>/aprovar`, `PATCH /api/triagens/<id>/reprovar`, `POST /api/triagens/<id>/paciente`, `GET /api/triagens/status/<status>`, `GET /api/triagens/prioridade/<prioridade>`, **`GET /api/triagens/<id>/sugestao-dentista`** |
...
| Arquivo | Conteúdo |
|---|---|
| [`docs/api_contratos.md`](docs/api_contratos.md) | Contrato detalhado de todos os endpoints com exemplos JSON |
